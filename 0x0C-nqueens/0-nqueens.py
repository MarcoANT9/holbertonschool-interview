...
def nQueens(N, r, queenList):
    """This program prints all the possible solutions for the NxN Queens
    problem; the conditions are:
        * You must place N queens in a NxN chessboard.
        * None of the Queens are place in a position in which they attack
    another Queen.
    """
    for i in range(N):
        flag = 0
